...
public class CreateCommentController implements Initializable {
    ...
    public void initial(double scale) {
        ...
        this.mainText.setLayoutX (156d* scale);
        this.mainText.setLayoutY(207d * scale);
        this.mainText.setFont(Font.font(30D * scale));

        this.textText.setFill(themeColor);
        this.textText.setLayoutX (105d* scale);
        this.textText.setLayoutY(265d * scale);
        ...
        this.doneButton.setLayoutX (240d* scale);
        this.doneButton.setLayoutY(347d * scale);
