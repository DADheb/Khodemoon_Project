...
public class First {
    ...
    public static void showFirstMenu() throws SQLException {
        Show.printLine();
    ...
    public static void showFollowRequest() throws SQLException {
        Show.printLine();
    ...
    public static void showSuggestedUsers() throws SQLException {
    ...
    public static void showAds() throws SQLException {
    ...
    public static void acceptIgnore() throws SQLException {
