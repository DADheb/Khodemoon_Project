...
import com.example.settings.Controller.UserController;
...
//        this.questionField.setStyle("-fx-background-color: #" + mode.toString().substring(2));
    ...
    public void quitSetting(MouseEvent mouseEvent) {
        //scene ghabli ro call kone
        System.exit(0);
    }
    ...
    public void quitChangePass(ActionEvent event) {
        Windows.setting();
    }
