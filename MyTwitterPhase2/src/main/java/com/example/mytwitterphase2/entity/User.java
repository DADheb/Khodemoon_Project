...
import com.example.mytwitterphase2.MainCommand;
...
public class User implements Comparable<User>{
    ...
    private Image profileImage = new Image(Objects.requireNonNull(MainGraphic.class.getResource("Photo/Project/UserProfWhite.png")).toExternalForm());
