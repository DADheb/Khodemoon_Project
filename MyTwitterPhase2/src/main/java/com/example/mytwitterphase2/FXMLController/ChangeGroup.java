...
public class ChangeGroup implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        headLabel.setLayoutX(144*scale);
        headLabel.setLayoutY(42*scale);
        ...
        next.setLayoutX(255*scale);
        next.setLayoutY(524*scale);
