...
public class GetUser implements Initializable {
    ...
    public void selected() throws InterruptedException, IOException, SQLException {
        Thread.sleep(10);
        if(type){
            Group g = LiveState.group;
            GroupController.newMember(g,LiveState.user);
