...
public class ChatGroupF implements Initializable {
    @FXML
    public Pane pane;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        scrollPane.setPrefHeight(Creator.height-50*scale);
        ...
        line.setStartX(57*scale);
        line.setEndX(171*scale);
        ...
        groupImage.setLayoutX(217.5*scale);
    ...
    public void goNewChat(MouseEvent mouseEvent) throws SQLException, IOException {
        LiveState.CGState = 3;
    ...
    public void goJustGroup(MouseEvent mouseEvent) throws SQLException, IOException {
        LiveState.state = 9;
