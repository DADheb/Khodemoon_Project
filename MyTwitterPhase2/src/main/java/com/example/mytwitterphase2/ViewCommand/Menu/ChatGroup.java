...
import com.example.mytwitterphase2.Controller.*;
...
public class ChatGroup {
    ...
    static public void search(Chat chat) throws SQLException {
        ...
        ArrayList<Message> messages = SQL.searchMessage(chat,text,DataBase.getConnection());
        Show.printLine();
    ...
    static public void search(Group group) throws SQLException {
        ...
        System.out.println("Enter text : ");
        String text = Show.getString();
        ArrayList<Message> messages = SQL.searchMessage(group,text,DataBase.getConnection());
        Show.printLine();
        System.out.println("Result : ");
        Show.showMessageList(messages,0,10);
        Show.printLine();
